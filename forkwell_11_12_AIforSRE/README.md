...
　私自身、LLMを開発・改良する能力やその意欲は現時点で持ち合わせていません。しかし、そのプラットフォームを最大限に活用し、適切に組み合わせることで、自分の仕事に新しい価値をもたらす立場を取ろうと考えています。Kubernetesやクラウドと同じように、LLMも道具として活用し、そこでの技術的な面白さを追求することが、今の自分にとって最も魅力的で実践的な道だと感じています。
